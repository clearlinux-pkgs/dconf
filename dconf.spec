...
Version  : 0.30.1
Release  : 16
URL      : https://download.gnome.org/sources/dconf/0.30/dconf-0.30.1.tar.xz
Source0  : https://download.gnome.org/sources/dconf/0.30/dconf-0.30.1.tar.xz
...
%prep
%setup -q -n dconf-0.30.1
pushd ..
cp -a dconf-0.30.1 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1545311348
