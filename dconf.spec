...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664142599
...
cp %{_builddir}/dconf-%{version}/COPYING %{buildroot}/usr/share/package-licenses/dconf/9a1929f4700d2407c70b507b3b2aaf6226a9543c || :
pushd ../build32/
