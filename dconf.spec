...
Source0  : https://download.gnome.org/sources/dconf/0.34/dconf-0.34.0.tar.xz
...
%prep
%setup -q -n dconf-0.34.0
pushd ..
cp -a dconf-0.34.0 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568081094
